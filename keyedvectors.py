...
class WordEmbeddingsKeyedVectors(BaseKeyedVectors):
    ...
    def wmdistance(document1, document2,wvmodel):
        ...
        * `Matt Kusner et al. "From Word Embeddings To Document Distances"
        ...
        document2 = ['__qxvca^&3fd?#_!$' +  str(i) for i in range(len(random_document_vectors))]
        ...
        for i, t1 in dictionary.items():
            ...
            for j, t2 in dictionary.items():
                ...
                distance_matrix[i, j] = distance_matrix[j, i] = sqrt(np_sum((wvmodel[t1] - wordvecs_random[t2])**2))
